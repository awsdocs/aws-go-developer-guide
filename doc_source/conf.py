...
htmlhelp_basename = 'AWSGoDeveloperGuide'
...
latex_documents = [
  (master_doc, 'AWSGoDeveloperGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awsgodeveloperguide', project, [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSGoDeveloperGuide', project,
   author, 'AWSGoDeveloperGuide', 'AWS SDK for Go Developer Guide.',
   'Miscellaneous'),
]
...
extlinks['doc-examples-go'] = (
    'https://github.com/awsdocs/aws-doc-sdk-examples/blob/master/go/%s',
    '')
