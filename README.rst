...
This repository contains source content for the upcoming *AWS SDK for Go Developer Guide*. The
source code for the **AWS SDK for Go** is also on GitHub, at https://github.com/aws/aws-sdk-go/.
